...
-- Started on 2025-10-27 18:16:48

\restrict fVml5OZ6Gx6BqM8QLbLkQcdGrpTSQBEYIyixSCAD0dPrFXb94lttITDI1nivd5S
...
\unrestrict fVml5OZ6Gx6BqM8QLbLkQcdGrpTSQBEYIyixSCAD0dPrFXb94lttITDI1nivd5S
...
\restrict Mdjp1gaO5g88J39nr2D3gmmiYU4ZzAXpSzDkH6cwdwF32jeUKJTGkmedft2hM9M

-- Dumped from database version 17.6 (Debian 17.6-2.pgdg13+1)
-- Dumped by pg_dump version 17.6

-- Started on 2025-10-27 18:16:49
...
-- Completed on 2025-10-27 18:16:55

--
-- PostgreSQL database dump complete
--

\unrestrict Mdjp1gaO5g88J39nr2D3gmmiYU4ZzAXpSzDkH6cwdwF32jeUKJTGkmedft2hM9M
...
\restrict ofz6gexCkI0ja56scgbhO19dHGo9oxDnRp5lhgfV1HBDrq9jHA12jbfWJuLwy99

-- Dumped from database version 17.6 (Debian 17.6-2.pgdg13+1)
-- Dumped by pg_dump version 17.6

-- Started on 2025-10-27 18:16:55
...
-- Completed on 2025-10-27 18:17:00

--
-- PostgreSQL database dump complete
--

\unrestrict ofz6gexCkI0ja56scgbhO19dHGo9oxDnRp5lhgfV1HBDrq9jHA12jbfWJuLwy99
...
\restrict ZGye35CRCD2fFQVMArBLcSpLdP54jn2qICO1yaJKGznpU2APyGx48BQDdTnD7A8

-- Dumped from database version 17.6 (Debian 17.6-2.pgdg13+1)
-- Dumped by pg_dump version 17.6

-- Started on 2025-10-27 18:17:01
...
--
-- TOC entry 6257 (class 1262 OID 16384)
...
\unrestrict ZGye35CRCD2fFQVMArBLcSpLdP54jn2qICO1yaJKGznpU2APyGx48BQDdTnD7A8
\connect railway
\restrict ZGye35CRCD2fFQVMArBLcSpLdP54jn2qICO1yaJKGznpU2APyGx48BQDdTnD7A8
...
--
-- TOC entry 703 (class 1255 OID 22588)
...
--
-- TOC entry 692 (class 1255 OID 21432)
...
--
-- TOC entry 757 (class 1255 OID 21696)
...
--
-- TOC entry 749 (class 1255 OID 21698)
...
--
-- TOC entry 733 (class 1255 OID 21697)
...
--
-- TOC entry 695 (class 1255 OID 21908)
...
--
-- TOC entry 742 (class 1255 OID 22475)
...
--
-- TOC entry 666 (class 1255 OID 22151)
...
--
-- TOC entry 721 (class 1255 OID 22442)
...
--
-- TOC entry 699 (class 1255 OID 21374)
...
--
-- TOC entry 671 (class 1255 OID 19387)
...
DECLARE
    ...
    v_data_col TEXT;
BEGIN
    -- Convert NEW record to JSON safely
    BEGIN
        v_json := to_jsonb(NEW);
    ...
    -- Determine a suitable record_id
    BEGIN
        v_record_id := COALESCE(
            (v_json ->> 'id')::BIGINT,
            (v_json ->> 'order_id')::BIGINT,
            (v_json ->> 'product_id')::BIGINT,
            (v_json ->> 'user_id')::BIGINT,
            (v_json ->> 'payment_id')::BIGINT,
            (v_json ->> 'shop_id')::BIGINT
        );
    EXCEPTION WHEN others THEN
        v_record_id := NULL;
    END;

    -- 🔍 Detect the correct column for operation/action
    SELECT CASE
        WHEN EXISTS (SELECT 1 FROM information_schema.columns
                     WHERE table_schema='public' AND table_name='sys_audit_log'
                       AND column_name='operation') THEN 'operation'
        WHEN EXISTS (SELECT 1 FROM information_schema.columns
                     WHERE table_schema='public' AND table_name='sys_audit_log'
                       AND column_name='action') THEN 'action'
        WHEN EXISTS (SELECT 1 FROM information_schema.columns
                     WHERE table_schema='public' AND table_name='sys_audit_log'
                       AND column_name='event_type') THEN 'event_type'
        ELSE NULL
    END INTO v_action_col;

    -- 🔍 Detect the correct column for JSON data payload
    SELECT CASE
        WHEN EXISTS (SELECT 1 FROM information_schema.columns
                     WHERE table_schema='public' AND table_name='sys_audit_log'
                       AND column_name='changed_data') THEN 'changed_data'
        WHEN EXISTS (SELECT 1 FROM information_schema.columns
                     WHERE table_schema='public' AND table_name='sys_audit_log'
                       AND column_name='data') THEN 'data'
        WHEN EXISTS (SELECT 1 FROM information_schema.columns
                     WHERE table_schema='public' AND table_name='sys_audit_log'
                       AND column_name='details') THEN 'details'
        WHEN EXISTS (SELECT 1 FROM information_schema.columns
                     WHERE table_schema='public' AND table_name='sys_audit_log'
                       AND column_name='payload') THEN 'payload'
        ELSE NULL
    END INTO v_data_col;

    -- ✅ Build dynamic SQL only if both columns are found
    IF v_action_col IS NOT NULL AND v_data_col IS NOT NULL THEN
        v_sql := format(
            'INSERT INTO public.sys_audit_log (table_name, %I, record_id, %I, changed_by, changed_at)
             VALUES (%L, %L, %s, %L::jsonb, %s, now())',
            v_action_col, v_data_col,
            v_table_name,
            v_operation,
            COALESCE(v_record_id::TEXT, 'NULL'),
            v_json::TEXT,
            COALESCE(current_setting('app.user_id', true), 'NULL')
        );
        EXECUTE v_sql;
    ELSE
        -- Fallback if structure is different
        RAISE NOTICE '⚠️ sys_audit_log missing expected columns; audit skipped.';
    END IF;
...
--
-- TOC entry 715 (class 1255 OID 22301)
...
--
-- TOC entry 802 (class 1255 OID 21329)
...
--
-- TOC entry 720 (class 1255 OID 20784)
...
--
-- TOC entry 702 (class 1255 OID 22132)
...
--
-- TOC entry 673 (class 1255 OID 22152)
...
--
-- TOC entry 725 (class 1255 OID 21808)
...
--
-- TOC entry 681 (class 1255 OID 21909)
...
--
-- TOC entry 667 (class 1255 OID 20941)
...
--
-- TOC entry 740 (class 1255 OID 20814)
...
--
-- TOC entry 786 (class 1255 OID 20834)
...
--
-- TOC entry 744 (class 1255 OID 21019)
...
--
-- TOC entry 679 (class 1255 OID 22589)
...
--
-- TOC entry 781 (class 1255 OID 19941)
...
--
-- TOC entry 691 (class 1255 OID 22652)
...
--
-- TOC entry 790 (class 1255 OID 22559)
...
--
-- TOC entry 798 (class 1255 OID 22395)
...
--
-- TOC entry 766 (class 1255 OID 21807)
...
--
-- TOC entry 787 (class 1255 OID 21258)
...
--
-- TOC entry 795 (class 1255 OID 20910)
...
--
-- TOC entry 737 (class 1255 OID 21959)
...
--
-- TOC entry 704 (class 1255 OID 21753)
...
--
-- TOC entry 783 (class 1255 OID 21327)
...
--
-- TOC entry 657 (class 1255 OID 22504)
...
--
-- TOC entry 731 (class 1255 OID 21020)
...
--
-- TOC entry 759 (class 1255 OID 21082)
...
--
-- TOC entry 801 (class 1255 OID 20715)
...
--
-- TOC entry 682 (class 1255 OID 22024)
...
--
-- TOC entry 747 (class 1255 OID 21375)
...
--
-- TOC entry 753 (class 1255 OID 21018)
...
--
-- TOC entry 689 (class 1255 OID 21754)
...
--
-- TOC entry 760 (class 1255 OID 22536)
...
--
-- TOC entry 685 (class 1255 OID 21618)
...
--
-- TOC entry 660 (class 1255 OID 21854)
...
--
-- TOC entry 776 (class 1255 OID 21620)
...
--
-- TOC entry 735 (class 1255 OID 20911)
...
--
-- TOC entry 714 (class 1255 OID 22474)
...
--
-- TOC entry 791 (class 1255 OID 21619)
...
--
-- TOC entry 700 (class 1255 OID 20975)
...
--
-- TOC entry 732 (class 1255 OID 21855)
...
--
-- TOC entry 763 (class 1255 OID 21123)
...
--
-- TOC entry 675 (class 1255 OID 21259)
...
--
-- TOC entry 716 (class 1255 OID 22702)
...
--
-- TOC entry 690 (class 1255 OID 21752)
...
--
-- TOC entry 765 (class 1255 OID 22701)
...
--
-- TOC entry 751 (class 1255 OID 21325)
...
--
-- TOC entry 784 (class 1255 OID 22273)
...
--
-- TOC entry 773 (class 1255 OID 21373)
...
--
-- TOC entry 674 (class 1255 OID 21326)
...
--
-- TOC entry 778 (class 1255 OID 21957)
...
--
-- TOC entry 718 (class 1255 OID 22713)
...
--
-- TOC entry 767 (class 1255 OID 22764)
-- Name: fn_manage_shop_staff(bigint, bigint, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fn_manage_shop_staff(p_shop_id bigint, p_user_id bigint, p_role text, p_action text DEFAULT 'add'::text) RETURNS text
    LANGUAGE plpgsql
    AS $$
BEGIN
  IF p_action='add' THEN
    INSERT INTO public.shop_staff(shop_id, user_id, role)
    VALUES (p_shop_id, p_user_id, p_role)
    ON CONFLICT (shop_id,user_id) DO UPDATE SET role=EXCLUDED.role;
    RETURN 'staff_added';
  ELSIF p_action='update' THEN
    UPDATE public.shop_staff SET role=p_role WHERE shop_id=p_shop_id AND user_id=p_user_id;
    RETURN 'staff_updated';
  ELSIF p_action='remove' THEN
    DELETE FROM public.shop_staff WHERE shop_id=p_shop_id AND user_id=p_user_id;
...
ALTER FUNCTION public.fn_manage_shop_staff(p_shop_id bigint, p_user_id bigint, p_role text, p_action text) OWNER TO postgres;

--
-- TOC entry 722 (class 1255 OID 21431)
...
--
-- TOC entry 771 (class 1255 OID 22737)
...
--
-- TOC entry 764 (class 1255 OID 22505)
...
--
-- TOC entry 669 (class 1255 OID 22443)
...
--
-- TOC entry 724 (class 1255 OID 22419)
...
--
-- TOC entry 686 (class 1255 OID 22537)
...
--
-- TOC entry 754 (class 1255 OID 22104)
...
--
-- TOC entry 706 (class 1255 OID 22025)
...
--
-- TOC entry 683 (class 1255 OID 22101)
...
--
-- TOC entry 730 (class 1255 OID 22206)
...
--
-- TOC entry 746 (class 1255 OID 21328)
...
--
-- TOC entry 696 (class 1255 OID 22274)
...
--
-- TOC entry 748 (class 1255 OID 21564)
...
--
-- TOC entry 658 (class 1255 OID 20865)
...
--
-- TOC entry 684 (class 1255 OID 19998)
...
--
-- TOC entry 758 (class 1255 OID 22272)
...
--
-- TOC entry 712 (class 1255 OID 22044)
...
--
-- TOC entry 793 (class 1255 OID 21805)
...
--
-- TOC entry 780 (class 1255 OID 22763)
-- Name: fn_register_shop_bot(text, bigint, bigint, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fn_register_shop_bot(p_bot_token text, p_owner_user bigint, p_shop_id bigint, p_bot_name text DEFAULT NULL::text) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_bot_id BIGINT;
...
BEGIN
  -- base codes
  v_shop_code := CONCAT('SHP', LPAD(p_shop_id::TEXT, 6, '0'));
  v_shop_slug := LOWER(CONCAT('autoshop-', p_shop_id));

  -- shop exists?
  SELECT EXISTS(SELECT 1 FROM public.shops WHERE shop_id = p_shop_id)
    INTO v_shop_exists;

  IF NOT v_shop_exists THEN
    -- build dynamic INSERT that only includes columns that exist
    v_sql := 'INSERT INTO public.shops (shop_id, shop_code, shop_name';

    -- optional columns (detected)
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='shop_slug') THEN
      v_sql := v_sql || ', shop_slug';
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='country') THEN
      v_sql := v_sql || ', country';
    ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='shop_country') THEN
      v_sql := v_sql || ', shop_country';
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='theme_color') THEN
      v_sql := v_sql || ', theme_color';
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='status') THEN
      v_sql := v_sql || ', status';
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='is_verified') THEN
      v_sql := v_sql || ', is_verified';
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='plan_type') THEN
      v_sql := v_sql || ', plan_type';
    END IF;
    -- ✅ NEW: shop_type if present (NOT NULL in your schema)
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='shop_type') THEN
      v_sql := v_sql || ', shop_type';
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='owner_user_id') THEN
      v_sql := v_sql || ', owner_user_id';
    END IF;

    v_sql := v_sql || ', created_at, updated_at) VALUES (' ||
              p_shop_id || ', ' ||
              quote_literal(v_shop_code) || ', ' ||
              quote_literal(CONCAT('AutoShop-', p_shop_id));

    -- values for detected columns (in same order)
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='shop_slug') THEN
      v_sql := v_sql || ', ' || quote_literal(v_shop_slug);
    END IF;

    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='country') THEN
      v_sql := v_sql || ', ' || quote_literal('Cambodia');
    ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='shop_country') THEN
      v_sql := v_sql || ', ' || quote_literal('Cambodia');
    END IF;

    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='theme_color') THEN
      v_sql := v_sql || ', ' || quote_literal('#000000');
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='status') THEN
      v_sql := v_sql || ', ' || quote_literal('active');
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='is_verified') THEN
      v_sql := v_sql || ', FALSE';
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='plan_type') THEN
      v_sql := v_sql || ', ' || quote_literal('basic');
    END IF;
    -- ✅ NEW: default for NOT NULL shop_type
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='shop_type') THEN
      v_sql := v_sql || ', ' || quote_literal('general');
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema='public' AND table_name='shops' AND column_name='owner_user_id') THEN
      v_sql := v_sql || ', ' || p_owner_user;
    END IF;

    v_sql := v_sql || ', now(), now()) ON CONFLICT (shop_id) DO NOTHING;';

    EXECUTE v_sql;
    RAISE NOTICE '⚙️ Shop % auto-created (code %, slug %, type general)', p_shop_id, v_shop_code, v_shop_slug;
  END IF;

  -- Link / upsert bot
  INSERT INTO public.shop_bots(bot_token, owner_user_id, shop_id, bot_name)
  VALUES (p_bot_token, p_owner_user, p_shop_id, p_bot_name)
  ON CONFLICT (bot_token)
  DO UPDATE SET
      owner_user_id = EXCLUDED.owner_user_id,
      shop_id       = EXCLUDED.shop_id,
      bot_name      = COALESCE(EXCLUDED.bot_name, public.shop_bots.bot_name)
  RETURNING bot_id INTO v_bot_id;

  -- Ensure owner in staff
  INSERT INTO public.shop_staff(shop_id, user_id, role)
  VALUES (p_shop_id, p_owner_user, 'owner')
...
ALTER FUNCTION public.fn_register_shop_bot(p_bot_token text, p_owner_user bigint, p_shop_id bigint, p_bot_name text) OWNER TO postgres;

--
-- TOC entry 688 (class 1255 OID 22023)
...
--
-- TOC entry 762 (class 1255 OID 22100)
...
--
-- TOC entry 672 (class 1255 OID 21081)
...
--
-- TOC entry 728 (class 1255 OID 22026)
...
--
-- TOC entry 678 (class 1255 OID 22538)
...
--
-- TOC entry 677 (class 1255 OID 22045)
...
--
-- TOC entry 770 (class 1255 OID 21124)
...
--
-- TOC entry 729 (class 1255 OID 22549)
...
--
-- TOC entry 768 (class 1255 OID 21958)
...
--
-- TOC entry 687 (class 1255 OID 21260)
...
--
-- TOC entry 743 (class 1255 OID 21433)
...
--
-- TOC entry 719 (class 1255 OID 22595)
...
--
-- TOC entry 676 (class 1255 OID 20912)
...
--
-- TOC entry 665 (class 1255 OID 19564)
...
--
-- TOC entry 774 (class 1255 OID 21806)
...
--
-- TOC entry 694 (class 1255 OID 20976)
...
--
-- TOC entry 707 (class 1255 OID 21910)
...
--
-- TOC entry 745 (class 1255 OID 21755)
...
--
-- TOC entry 659 (class 1255 OID 20943)
...
--
-- TOC entry 797 (class 1255 OID 22153)
...
--
-- TOC entry 794 (class 1255 OID 21566)
...
--
-- TOC entry 663 (class 1255 OID 22334)
...
--
-- TOC entry 656 (class 1255 OID 21330)
...
--
-- TOC entry 693 (class 1255 OID 21856)
...
--
-- TOC entry 756 (class 1255 OID 22138)
...
--
-- TOC entry 777 (class 1255 OID 22590)
...
--
-- TOC entry 799 (class 1255 OID 22765)
-- Name: fn_shop_update_product(bigint, bigint, text, numeric, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.fn_shop_update_product(p_user_id bigint, p_product_id bigint, p_name text DEFAULT NULL::text, p_price numeric DEFAULT NULL::numeric, p_stock integer DEFAULT NULL::integer) RETURNS text
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_shop BIGINT;
  v_role TEXT;
BEGIN
  SELECT s.shop_id, st.role
    INTO v_shop, v_role
    FROM public.products p
    JOIN public.shops s ON s.shop_id = p.shop_id
    LEFT JOIN public.shop_staff st ON st.shop_id=s.shop_id AND st.user_id=p_user_id
  WHERE p.product_id = p_product_id;

  IF v_role IS NULL THEN
    RAISE EXCEPTION 'Access denied: user not in staff list';
  END IF;
  IF v_role NOT IN ('owner','manager') THEN
    RAISE EXCEPTION 'Access denied: insufficient role (need owner/manager)';
  END IF;

  UPDATE public.products
     SET product_name = COALESCE(p_name, product_name),
         price        = COALESCE(p_price, price),
         stock_qty    = COALESCE(p_stock, stock_qty),
         updated_at   = now()
...
ALTER FUNCTION public.fn_shop_update_product(p_user_id bigint, p_product_id bigint, p_name text, p_price numeric, p_stock integer) OWNER TO postgres;

--
-- TOC entry 772 (class 1255 OID 21907)
...
--
-- TOC entry 792 (class 1255 OID 22394)
...
--
-- TOC entry 736 (class 1255 OID 20974)
...
--
-- TOC entry 705 (class 1255 OID 20942)
...
--
-- TOC entry 761 (class 1255 OID 21565)
...
--
-- TOC entry 726 (class 1255 OID 21122)
...
--
-- TOC entry 680 (class 1255 OID 20804)
...
--
-- TOC entry 662 (class 1255 OID 22131)
...
--
-- TOC entry 711 (class 1255 OID 22712)
...
--
-- TOC entry 734 (class 1255 OID 24579)
-- Name: get_totals(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_totals() RETURNS TABLE(total_shops bigint, total_products bigint)
    LANGUAGE sql
    AS $$
  SELECT
...
ALTER FUNCTION public.get_totals() OWNER TO postgres;

--
-- TOC entry 708 (class 1255 OID 20007)
...
--
-- TOC entry 779 (class 1255 OID 19664)
...
--
-- TOC entry 752 (class 1255 OID 19448)
...
--
-- TOC entry 782 (class 1255 OID 21021)
...
--
-- TOC entry 738 (class 1255 OID 22027)
...
--
-- TOC entry 701 (class 1255 OID 22028)
...
--
-- TOC entry 785 (class 1255 OID 22102)
...
--
-- TOC entry 668 (class 1255 OID 24578)
-- Name: upsert_telegram_user(jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.upsert_telegram_user(user_json jsonb) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
DECLARE
  t_id bigint;
  ...
  existing_id bigint;
BEGIN
  t_id := (user_json->>'telegram_id')::bigint;
  t_first := user_json->>'first_name';
  t_last := user_json->>'last_name';
  t_username := user_json->>'username';
  t_lang := user_json->>'language_code';
  t_is_bot := COALESCE((user_json->>'is_bot')::boolean, false);

  SELECT id INTO existing_id FROM users WHERE telegram_id = t_id;

  IF existing_id IS NULL THEN
    INSERT INTO users (telegram_id, is_bot, first_name, last_name, username, language_code, last_seen, metadata)
    VALUES (t_id, t_is_bot, t_first, t_last, t_username, t_lang, now(), user_json)
    RETURNING id INTO existing_id;
  ELSE
    UPDATE users
    SET is_bot = t_is_bot,
        first_name = COALESCE(NULLIF(t_first,''), first_name),
        last_name = COALESCE(NULLIF(t_last,''), last_name),
        username = COALESCE(NULLIF(t_username,''), username),
        language_code = COALESCE(NULLIF(t_lang,''), language_code),
        last_seen = now(),
        metadata = COALESCE(metadata, '{}'::jsonb) || user_json
...
ALTER FUNCTION public.upsert_telegram_user(user_json jsonb) OWNER TO postgres;
...
--
-- TOC entry 654 (class 1259 OID 22739)
...
CREATE TABLE public.shop_staff (
    ...
    CONSTRAINT shop_staff_role_check CHECK ((role = ANY (ARRAY['owner'::text, 'manager'::text, 'staff'::text, 'viewer'::text])))
);
...
--
-- TOC entry 653 (class 1259 OID 22738)
-- Name: shop_staff_staff_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.shop_staff_staff_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.shop_staff_staff_id_seq OWNER TO postgres;

--
-- TOC entry 6369 (class 0 OID 0)
-- Dependencies: 653
-- Name: shop_staff_staff_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.shop_staff_staff_id_seq OWNED BY public.shop_staff.staff_id;
...
--
-- TOC entry 655 (class 1259 OID 22766)
-- Name: v_shop_hierarchy; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_shop_hierarchy AS
 SELECT sh.shop_id,
    sh.shop_name,
    b.bot_id,
    b.bot_token,
    u.username AS owner_username,
    count(st.staff_id) FILTER (WHERE (st.role <> 'owner'::text)) AS staff_count,
    jsonb_agg(jsonb_build_object('user_id', st.user_id, 'role', st.role)) AS staff_detail
   FROM (((public.shops sh
     LEFT JOIN public.shop_bots b ON ((b.shop_id = sh.shop_id)))
     LEFT JOIN public.users u ON ((u.user_id = b.owner_user_id)))
     LEFT JOIN public.shop_staff st ON ((st.shop_id = sh.shop_id)))
  GROUP BY sh.shop_id, sh.shop_name, b.bot_id, b.bot_token, u.username;


ALTER VIEW public.v_shop_hierarchy OWNER TO postgres;
...
--
-- TOC entry 4904 (class 2604 OID 20839)
...
--
-- TOC entry 4787 (class 2604 OID 17721)
...
--
-- TOC entry 4783 (class 2604 OID 17709)
...
--
-- TOC entry 5046 (class 2604 OID 21684)
...
--
-- TOC entry 5041 (class 2604 OID 21647)
...
--
-- TOC entry 5043 (class 2604 OID 21668)
...
--
-- TOC entry 5036 (class 2604 OID 21635)
...
--
-- TOC entry 5174 (class 2604 OID 22515)
...
--
-- TOC entry 5088 (class 2604 OID 21941)
...
--
-- TOC entry 5165 (class 2604 OID 22485)
...
--
-- TOC entry 5169 (class 2604 OID 22497)
...
--
-- TOC entry 4963 (class 2604 OID 21277)
...
--
-- TOC entry 5124 (class 2604 OID 22228)
...
--
-- TOC entry 4959 (class 2604 OID 21252)
...
--
-- TOC entry 4954 (class 2604 OID 21219)
...
--
-- TOC entry 5057 (class 2604 OID 21747)
...
--
-- TOC entry 4989 (class 2604 OID 21395)
...
--
-- TOC entry 5153 (class 2604 OID 22454)
...
--
-- TOC entry 4949 (class 2604 OID 21198)
...
--
-- TOC entry 5031 (class 2604 OID 21593)
...
--
-- TOC entry 5034 (class 2604 OID 21609)
...
--
-- TOC entry 5026 (class 2604 OID 21580)
...
--
-- TOC entry 5086 (class 2604 OID 21925)
...
--
-- TOC entry 5090 (class 2604 OID 21952)
...
--
-- TOC entry 5080 (class 2604 OID 21881)
...
--
-- TOC entry 5084 (class 2604 OID 21896)
...
--
-- TOC entry 5208 (class 2604 OID 22692)
...
--
-- TOC entry 5077 (class 2604 OID 21870)
...
--
-- TOC entry 4943 (class 2604 OID 21087)
...
--
-- TOC entry 5010 (class 2604 OID 21510)
...
--
-- TOC entry 4975 (class 2604 OID 21319)
...
--
-- TOC entry 5049 (class 2604 OID 21712)
...
--
-- TOC entry 5053 (class 2604 OID 21724)
...
--
-- TOC entry 4947 (class 2604 OID 21115)
...
--
-- TOC entry 5122 (class 2604 OID 22216)
...
--
-- TOC entry 5022 (class 2604 OID 21558)
...
--
-- TOC entry 4993 (class 2604 OID 21408)
...
--
-- TOC entry 5006 (class 2604 OID 21495)
...
--
-- TOC entry 5162 (class 2604 OID 22469)
...
--
-- TOC entry 4945 (class 2604 OID 21096)
...
--
-- TOC entry 5149 (class 2604 OID 22434)
...
--
-- TOC entry 4956 (class 2604 OID 21235)
...
--
-- TOC entry 5179 (class 2604 OID 22529)
...
--
-- TOC entry 5014 (class 2604 OID 21536)
...
--
-- TOC entry 5016 (class 2604 OID 21545)
...
--
-- TOC entry 5145 (class 2604 OID 22424)
...
--
-- TOC entry 5060 (class 2604 OID 21768)
...
--
-- TOC entry 5055 (class 2604 OID 21737)
...
--
-- TOC entry 5066 (class 2604 OID 21795)
...
--
-- TOC entry 5062 (class 2604 OID 21778)
...
--
-- TOC entry 4997 (class 2604 OID 21420)
...
--
-- TOC entry 5073 (class 2604 OID 21835)
...
--
-- TOC entry 5075 (class 2604 OID 21845)
...
--
-- TOC entry 5069 (class 2604 OID 21823)
...
--
-- TOC entry 4968 (class 2604 OID 21299)
...
--
-- TOC entry 4936 (class 2604 OID 21004)
...
--
-- TOC entry 4930 (class 2604 OID 20989)
...
--
-- TOC entry 4812 (class 2604 OID 17798)
...
--
-- TOC entry 4816 (class 2604 OID 17810)
...
--
-- TOC entry 4882 (class 2604 OID 19982)
...
--
-- TOC entry 4984 (class 2604 OID 21355)
...
--
-- TOC entry 4772 (class 2604 OID 17676)
...
--
-- TOC entry 4632 (class 2604 OID 19161)
...
--
-- TOC entry 4796 (class 2604 OID 17756)
...
--
-- TOC entry 4769 (class 2604 OID 17667)
...
--
-- TOC entry 4821 (class 2604 OID 17831)
...
--
-- TOC entry 4986 (class 2604 OID 21366)
...
--
-- TOC entry 4765 (class 2604 OID 17657)
...
--
-- TOC entry 4804 (class 2604 OID 17776)
...
--
-- TOC entry 4754 (class 2604 OID 17632)
...
--
-- TOC entry 4762 (class 2604 OID 17646)
...
--
-- TOC entry 4780 (class 2604 OID 17700)
...
--
-- TOC entry 4854 (class 2604 OID 19646)
...
--
-- TOC entry 4818 (class 2604 OID 17820)
...
--
-- TOC entry 4826 (class 2604 OID 17850)
...
--
-- TOC entry 4836 (class 2604 OID 17882)
...
--
-- TOC entry 4870 (class 2604 OID 19929)
...
--
-- TOC entry 4618 (class 2604 OID 16393)
...
--
-- TOC entry 4908 (class 2604 OID 20878)
...
--
-- TOC entry 4919 (class 2604 OID 20905)
...
--
-- TOC entry 4927 (class 2604 OID 20967)
...
--
-- TOC entry 4925 (class 2604 OID 20956)
...
--
-- TOC entry 4893 (class 2604 OID 20773)
...
--
-- TOC entry 4823 (class 2604 OID 17841)
...
--
-- TOC entry 4940 (class 2604 OID 21063)
...
--
-- TOC entry 4776 (class 2604 OID 17688)
...
--
-- TOC entry 4736 (class 2604 OID 17565)
...
--
-- TOC entry 4733 (class 2604 OID 17554)
...
--
-- TOC entry 4863 (class 2604 OID 19708)
...
--
-- TOC entry 4743 (class 2604 OID 17591)
...
--
-- TOC entry 4651 (class 2604 OID 19158)
...
--
-- TOC entry 4740 (class 2604 OID 17579)
...
--
-- TOC entry 4664 (class 2604 OID 16545)
...
--
-- TOC entry 4661 (class 2604 OID 16530)
...
--
-- TOC entry 4849 (class 2604 OID 19604)
...
--
-- TOC entry 4655 (class 2604 OID 19145)
...
--
-- TOC entry 4640 (class 2604 OID 19087)
...
--
-- TOC entry 4841 (class 2604 OID 19578)
...
--
-- TOC entry 4809 (class 2604 OID 17787)
...
--
-- TOC entry 4858 (class 2604 OID 19670)
...
--
-- TOC entry 4874 (class 2604 OID 19946)
...
--
-- TOC entry 4864 (class 2604 OID 19719)
...
--
-- TOC entry 4861 (class 2604 OID 19698)
...
--
-- TOC entry 5099 (class 2604 OID 22003)
...
--
-- TOC entry 5095 (class 2604 OID 21985)
...
--
-- TOC entry 5092 (class 2604 OID 21972)
...
--
-- TOC entry 5107 (class 2604 OID 22072)
...
--
-- TOC entry 5103 (class 2604 OID 22060)
...
--
-- TOC entry 4834 (class 2604 OID 17872)
...
--
-- TOC entry 5213 (class 2604 OID 22718)
...
--
-- TOC entry 5216 (class 2604 OID 22742)
-- Name: shop_staff staff_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.shop_staff ALTER COLUMN staff_id SET DEFAULT nextval('public.shop_staff_staff_id_seq'::regclass);


--
-- TOC entry 4799 (class 2604 OID 19262)
...
--
-- TOC entry 4620 (class 2604 OID 19034)
...
--
-- TOC entry 4839 (class 2604 OID 19540)
...
--
-- TOC entry 4830 (class 2604 OID 17862)
...
--
-- TOC entry 4750 (class 2604 OID 17620)
...
--
-- TOC entry 5133 (class 2604 OID 22295)
...
--
-- TOC entry 5185 (class 2604 OID 22569)
...
--
-- TOC entry 5194 (class 2604 OID 22662)
...
--
-- TOC entry 5119 (class 2604 OID 22144)
...
--
-- TOC entry 5135 (class 2604 OID 22339)
...
--
-- TOC entry 5140 (class 2604 OID 22382)
...
--
-- TOC entry 5182 (class 2604 OID 22554)
...
--
-- TOC entry 5189 (class 2604 OID 22581)
...
--
-- TOC entry 5202 (class 2604 OID 22678)
...
--
-- TOC entry 4789 (class 2604 OID 17731)
...
--
-- TOC entry 4885 (class 2604 OID 20706)
...
--
-- TOC entry 4793 (class 2604 OID 17743)
...
--
-- TOC entry 4866 (class 2604 OID 19876)
...
--
-- TOC entry 4887 (class 2604 OID 20728)
...
--
-- TOC entry 4745 (class 2604 OID 17599)
...
--
-- TOC entry 4865 (class 2604 OID 19738)
...
--
-- TOC entry 4890 (class 2604 OID 20757)
...
--
-- TOC entry 4747 (class 2604 OID 17609)
...
--
-- TOC entry 4852 (class 2604 OID 19629)
...
--
-- TOC entry 5588 (class 2606 OID 20853)
...
--
-- TOC entry 5584 (class 2606 OID 20847)
...
--
-- TOC entry 5586 (class 2606 OID 20845)
...
--
-- TOC entry 5328 (class 2606 OID 16768)
...
--
-- TOC entry 5326 (class 2606 OID 16755)
...
--
-- TOC entry 5311 (class 2606 OID 16707)
...
--
-- TOC entry 5313 (class 2606 OID 16705)
...
--
-- TOC entry 5450 (class 2606 OID 17726)
...
--
-- TOC entry 5315 (class 2606 OID 16714)
...
--
-- TOC entry 5317 (class 2606 OID 16716)
...
--
-- TOC entry 5307 (class 2606 OID 16695)
...
--
-- TOC entry 5309 (class 2606 OID 16697)
...
--
-- TOC entry 5448 (class 2606 OID 17716)
...
--
-- TOC entry 5319 (class 2606 OID 16740)
...
--
-- TOC entry 5321 (class 2606 OID 16736)
...
--
-- TOC entry 5323 (class 2606 OID 16738)
...
--
-- TOC entry 5692 (class 2606 OID 21690)
...
--
-- TOC entry 5687 (class 2606 OID 21652)
...
--
-- TOC entry 5690 (class 2606 OID 21674)
...
--
-- TOC entry 5684 (class 2606 OID 21641)
...
--
-- TOC entry 5784 (class 2606 OID 22524)
...
--
-- TOC entry 5723 (class 2606 OID 21946)
...
--
-- TOC entry 5780 (class 2606 OID 22492)
...
--
-- TOC entry 5782 (class 2606 OID 22503)
...
--
-- TOC entry 5762 (class 2606 OID 22266)
...
--
-- TOC entry 5641 (class 2606 OID 21283)
...
--
-- TOC entry 5760 (class 2606 OID 22246)
...
--
-- TOC entry 5758 (class 2606 OID 22235)
...
--
-- TOC entry 5648 (class 2606 OID 21314)
...
--
-- TOC entry 5639 (class 2606 OID 21257)
...
--
-- TOC entry 5633 (class 2606 OID 21224)
...
--
-- TOC entry 5700 (class 2606 OID 21751)
...
--
-- TOC entry 5659 (class 2606 OID 21402)
...
--
-- TOC entry 5776 (class 2606 OID 22464)
...
--
-- TOC entry 5631 (class 2606 OID 21204)
...
--
-- TOC entry 5680 (class 2606 OID 21599)
...
--
-- TOC entry 5682 (class 2606 OID 21612)
...
--
-- TOC entry 5678 (class 2606 OID 21588)
...
--
-- TOC entry 5720 (class 2606 OID 21930)
...
--
-- TOC entry 5726 (class 2606 OID 21955)
...
--
-- TOC entry 5716 (class 2606 OID 21886)
...
--
-- TOC entry 5718 (class 2606 OID 21901)
...
--
-- TOC entry 5802 (class 2606 OID 22700)
...
--
-- TOC entry 5714 (class 2606 OID 21876)
...
--
-- TOC entry 5622 (class 2606 OID 21090)
...
--
-- TOC entry 5668 (class 2606 OID 21515)
...
--
-- TOC entry 5650 (class 2606 OID 21324)
...
--
-- TOC entry 5694 (class 2606 OID 21719)
...
--
-- TOC entry 5696 (class 2606 OID 21727)
...
--
-- TOC entry 5628 (class 2606 OID 21120)
...
--
-- TOC entry 5754 (class 2606 OID 22221)
...
--
-- TOC entry 5756 (class 2606 OID 22223)
...
--
-- TOC entry 5676 (class 2606 OID 21563)
...
--
-- TOC entry 5662 (class 2606 OID 21415)
...
--
-- TOC entry 5666 (class 2606 OID 21500)
...
--
-- TOC entry 5778 (class 2606 OID 22473)
...
--
-- TOC entry 5625 (class 2606 OID 21099)
...
--
-- TOC entry 5774 (class 2606 OID 22441)
...
--
-- TOC entry 5636 (class 2606 OID 21241)
...
--
-- TOC entry 5786 (class 2606 OID 22535)
...
--
-- TOC entry 5670 (class 2606 OID 21539)
...
--
-- TOC entry 5673 (class 2606 OID 21552)
...
--
-- TOC entry 5772 (class 2606 OID 22429)
...
--
-- TOC entry 5702 (class 2606 OID 21773)
...
--
-- TOC entry 5698 (class 2606 OID 21742)
...
--
-- TOC entry 5706 (class 2606 OID 21799)
...
--
-- TOC entry 5704 (class 2606 OID 21785)
...
--
-- TOC entry 5664 (class 2606 OID 21430)
...
--
-- TOC entry 5710 (class 2606 OID 21840)
...
--
-- TOC entry 5712 (class 2606 OID 21848)
...
--
-- TOC entry 5708 (class 2606 OID 21830)
...
--
-- TOC entry 5644 (class 2606 OID 21305)
...
--
-- TOC entry 5646 (class 2606 OID 21303)
...
--
-- TOC entry 5750 (class 2606 OID 22125)
...
--
-- TOC entry 5616 (class 2606 OID 21011)
...
--
-- TOC entry 5613 (class 2606 OID 20998)
...
--
-- TOC entry 5404 (class 2606 OID 17165)
...
--
-- TOC entry 5466 (class 2606 OID 17805)
...
--
-- TOC entry 5468 (class 2606 OID 17815)
...
--
-- TOC entry 5550 (class 2606 OID 19988)
...
--
-- TOC entry 5552 (class 2606 OID 19990)
...
--
-- TOC entry 5654 (class 2606 OID 21360)
...
--
-- TOC entry 5411 (class 2606 OID 17201)
...
--
-- TOC entry 5441 (class 2606 OID 17683)
...
--
-- TOC entry 5241 (class 2606 OID 19163)
...
--
-- TOC entry 5243 (class 2606 OID 16450)
...
--
-- TOC entry 5363 (class 2606 OID 16973)
...
--
-- TOC entry 5458 (class 2606 OID 17760)
...
--
-- TOC entry 5439 (class 2606 OID 17671)
...
--
-- TOC entry 5396 (class 2606 OID 17139)
...
--
-- TOC entry 5398 (class 2606 OID 17137)
...
--
-- TOC entry 5505 (class 2606 OID 19624)
...
--
-- TOC entry 5548 (class 2606 OID 19972)
...
--
-- TOC entry 5473 (class 2606 OID 17836)
...
--
-- TOC entry 5657 (class 2606 OID 21372)
...
--
-- TOC entry 5349 (class 2606 OID 19243)
...
--
-- TOC entry 5351 (class 2606 OID 16915)
...
--
-- TOC entry 5370 (class 2606 OID 17002)
...
--
-- TOC entry 5437 (class 2606 OID 17662)
...
--
-- TOC entry 5462 (class 2606 OID 17782)
...
--
-- TOC entry 5346 (class 2606 OID 19267)
...
--
-- TOC entry 5433 (class 2606 OID 17641)
...
--
-- TOC entry 5357 (class 2606 OID 16947)
...
--
-- TOC entry 5435 (class 2606 OID 17652)
...
--
-- TOC entry 5446 (class 2606 OID 17704)
...
--
-- TOC entry 5509 (class 2606 OID 19653)
...
--
-- TOC entry 5338 (class 2606 OID 16853)
...
--
-- TOC entry 5470 (class 2606 OID 17826)
...
--
-- TOC entry 5477 (class 2606 OID 17857)
...
--
-- TOC entry 5479 (class 2606 OID 17855)
...
--
-- TOC entry 5485 (class 2606 OID 17888)
...
--
-- TOC entry 5544 (class 2606 OID 19934)
...
--
-- TOC entry 5409 (class 2606 OID 17175)
...
--
-- TOC entry 5229 (class 2606 OID 16398)
...
--
-- TOC entry 5592 (class 2606 OID 20884)
...
--
-- TOC entry 5599 (class 2606 OID 20908)
...
--
-- TOC entry 5609 (class 2606 OID 20971)
...
--
-- TOC entry 5611 (class 2606 OID 20973)
...
--
-- TOC entry 5596 (class 2606 OID 20898)
...
--
-- TOC entry 5607 (class 2606 OID 20961)
...
--
-- TOC entry 5602 (class 2606 OID 20927)
...
--
-- TOC entry 5604 (class 2606 OID 20935)
...
--
-- TOC entry 5575 (class 2606 OID 20778)
...
--
-- TOC entry 5487 (class 2606 OID 18927)
...
--
-- TOC entry 5475 (class 2606 OID 17845)
...
--
-- TOC entry 5368 (class 2606 OID 16985)
...
--
-- TOC entry 5620 (class 2606 OID 21069)
...
--
-- TOC entry 5443 (class 2606 OID 17695)
...
--
-- TOC entry 5361 (class 2606 OID 16963)
...
--
-- TOC entry 5416 (class 2606 OID 17574)
...
--
-- TOC entry 5418 (class 2606 OID 17572)
...
--
-- TOC entry 5383 (class 2606 OID 19214)
...
--
-- TOC entry 5336 (class 2606 OID 16839)
...
--
-- TOC entry 5414 (class 2606 OID 17560)
...
--
-- TOC entry 5377 (class 2606 OID 17027)
...
--
-- TOC entry 5379 (class 2606 OID 19176)
...
--
-- TOC entry 5389 (class 2606 OID 19222)
...
--
-- TOC entry 5521 (class 2606 OID 19714)
...
--
-- TOC entry 5523 (class 2606 OID 19712)
...
--
-- TOC entry 5422 (class 2606 OID 17594)
...
--
-- TOC entry 5258 (class 2606 OID 19160)
...
--
-- TOC entry 5332 (class 2606 OID 16801)
...
--
-- TOC entry 5541 (class 2606 OID 19902)
...
--
-- TOC entry 5420 (class 2606 OID 17586)
...
--
-- TOC entry 5275 (class 2606 OID 16548)
...
--
-- TOC entry 5277 (class 2606 OID 16550)
...
--
-- TOC entry 5267 (class 2606 OID 19893)
...
--
-- TOC entry 5269 (class 2606 OID 16540)
...
--
-- TOC entry 5271 (class 2606 OID 16538)
...
--
-- TOC entry 5501 (class 2606 OID 19609)
...
--
-- TOC entry 5503 (class 2606 OID 19611)
...
--
-- TOC entry 5261 (class 2606 OID 19147)
...
--
-- TOC entry 5263 (class 2606 OID 16520)
...
--
-- TOC entry 5251 (class 2606 OID 19089)
...
--
-- TOC entry 5253 (class 2606 OID 16475)
...
--
-- TOC entry 5255 (class 2606 OID 16477)
...
--
-- TOC entry 5495 (class 2606 OID 19593)
...
--
-- TOC entry 5497 (class 2606 OID 19591)
...
--
-- TOC entry 5464 (class 2606 OID 17793)
...
--
-- TOC entry 5394 (class 2606 OID 19235)
...
--
-- TOC entry 5515 (class 2606 OID 19676)
...
--
-- TOC entry 5546 (class 2606 OID 19953)
...
--
-- TOC entry 5525 (class 2606 OID 19721)
...
--
-- TOC entry 5527 (class 2606 OID 19723)
...
--
-- TOC entry 5517 (class 2606 OID 19701)
...
--
-- TOC entry 5519 (class 2606 OID 19703)
...
--
-- TOC entry 5736 (class 2606 OID 22010)
...
--
-- TOC entry 5738 (class 2606 OID 22008)
...
--
-- TOC entry 5740 (class 2606 OID 22017)
...
--
-- TOC entry 5734 (class 2606 OID 21992)
...
--
-- TOC entry 5729 (class 2606 OID 21980)
...
--
-- TOC entry 5731 (class 2606 OID 21978)
...
--
-- TOC entry 5748 (class 2606 OID 22099)
...
--
-- TOC entry 5746 (class 2606 OID 22079)
...
--
-- TOC entry 5743 (class 2606 OID 22067)
...
--
-- TOC entry 5483 (class 2606 OID 17877)
...
--
-- TOC entry 5804 (class 2606 OID 22726)
...
--
-- TOC entry 5806 (class 2606 OID 22724)
...
--
-- TOC entry 5330 (class 2606 OID 16782)
...
--
-- TOC entry 5402 (class 2606 OID 19261)
...
--
-- TOC entry 5808 (class 2606 OID 22750)
-- Name: shop_staff shop_staff_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.shop_staff
    ADD CONSTRAINT shop_staff_pkey PRIMARY KEY (staff_id);


--
-- TOC entry 5810 (class 2606 OID 22752)
-- Name: shop_staff shop_staff_shop_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.shop_staff
    ADD CONSTRAINT shop_staff_shop_id_user_id_key UNIQUE (shop_id, user_id);


--
-- TOC entry 5460 (class 2606 OID 19264)
...
--
-- TOC entry 5235 (class 2606 OID 19036)
...
--
-- TOC entry 5237 (class 2606 OID 16430)
...
--
-- TOC entry 5239 (class 2606 OID 16432)
...
--
-- TOC entry 5491 (class 2606 OID 19543)
...
--
-- TOC entry 5481 (class 2606 OID 17867)
...
--
-- TOC entry 5431 (class 2606 OID 17627)
...
--
-- TOC entry 5764 (class 2606 OID 22300)
...
--
-- TOC entry 5790 (class 2606 OID 22576)
...
--
-- TOC entry 5794 (class 2606 OID 22671)
...
--
-- TOC entry 5796 (class 2606 OID 22673)
...
--
-- TOC entry 5752 (class 2606 OID 22150)
...
--
-- TOC entry 5770 (class 2606 OID 22393)
...
--
-- TOC entry 5766 (class 2606 OID 22347)
...
--
-- TOC entry 5768 (class 2606 OID 22385)
...
--
-- TOC entry 5788 (class 2606 OID 22558)
...
--
-- TOC entry 5792 (class 2606 OID 22587)
...
--
-- TOC entry 5800 (class 2606 OID 22685)
...
--
-- TOC entry 5452 (class 2606 OID 17738)
...
--
-- TOC entry 5565 (class 2606 OID 20711)
...
--
-- TOC entry 5454 (class 2606 OID 17749)
...
--
-- TOC entry 5456 (class 2606 OID 17751)
...
--
-- TOC entry 5340 (class 2606 OID 16869)
...
--
-- TOC entry 5342 (class 2606 OID 16867)
...
--
-- TOC entry 5535 (class 2606 OID 19881)
...
--
-- TOC entry 5537 (class 2606 OID 19879)
...
--
-- TOC entry 5652 (class 2606 OID 21350)
...
--
-- TOC entry 5567 (class 2606 OID 20738)
...
--
-- TOC entry 5569 (class 2606 OID 20736)
...
--
-- TOC entry 5571 (class 2606 OID 20734)
...
--
-- TOC entry 5427 (class 2606 OID 17604)
...
--
-- TOC entry 5295 (class 2606 OID 16625)
...
--
-- TOC entry 5579 (class 2606 OID 20796)
...
--
-- TOC entry 5299 (class 2606 OID 16638)
...
--
-- TOC entry 5334 (class 2606 OID 16820)
...
--
-- TOC entry 5582 (class 2606 OID 20823)
...
--
-- TOC entry 5302 (class 2606 OID 16660)
...
--
-- TOC entry 5531 (class 2606 OID 19740)
...
--
-- TOC entry 5533 (class 2606 OID 19742)
...
--
-- TOC entry 5573 (class 2606 OID 20763)
...
--
-- TOC entry 5305 (class 2606 OID 16680)
...
--
-- TOC entry 5429 (class 2606 OID 17615)
...
--
-- TOC entry 5282 (class 2606 OID 16590)
...
--
-- TOC entry 5284 (class 2606 OID 18933)
...
--
-- TOC entry 5292 (class 2606 OID 16603)
...
--
-- TOC entry 5286 (class 2606 OID 22711)
...
--
-- TOC entry 5288 (class 2606 OID 16588)
...
--
-- TOC entry 5507 (class 2606 OID 19634)
...
--
-- TOC entry 5589 (class 1259 OID 20864)
...
--
-- TOC entry 5324 (class 1259 OID 16746)
...
--
-- TOC entry 5688 (class 1259 OID 21663)
...
--
-- TOC entry 5724 (class 1259 OID 21947)
...
--
-- TOC entry 5642 (class 1259 OID 21294)
...
--
-- TOC entry 5634 (class 1259 OID 21230)
...
--
-- TOC entry 5660 (class 1259 OID 21403)
...
--
-- TOC entry 5721 (class 1259 OID 21936)
...
--
-- TOC entry 5727 (class 1259 OID 21956)
...
--
-- TOC entry 5623 (class 1259 OID 21091)
...
--
-- TOC entry 5629 (class 1259 OID 21121)
...
--
-- TOC entry 5626 (class 1259 OID 21110)
...
--
-- TOC entry 5637 (class 1259 OID 21247)
...
--
-- TOC entry 5671 (class 1259 OID 21540)
...
--
-- TOC entry 5617 (class 1259 OID 21017)
...
--
-- TOC entry 5614 (class 1259 OID 20999)
...
--
-- TOC entry 5405 (class 1259 OID 17166)
...
--
-- TOC entry 5553 (class 1259 OID 19997)
...
--
-- TOC entry 5554 (class 1259 OID 19996)
...
--
-- TOC entry 5655 (class 1259 OID 21361)
...
--
-- TOC entry 5412 (class 1259 OID 17202)
...
--
-- TOC entry 5244 (class 1259 OID 16568)
...
--
-- TOC entry 5245 (class 1259 OID 16567)
...
--
-- TOC entry 5364 (class 1259 OID 16974)
...
--
-- TOC entry 5399 (class 1259 OID 17140)
...
--
-- TOC entry 5352 (class 1259 OID 16937)
...
--
-- TOC entry 5353 (class 1259 OID 20752)
...
--
-- TOC entry 5354 (class 1259 OID 16938)
...
--
-- TOC entry 5355 (class 1259 OID 16936)
...
--
-- TOC entry 5371 (class 1259 OID 17013)
...
--
-- TOC entry 5618 (class 1259 OID 21080)
...
--
-- TOC entry 5347 (class 1259 OID 16901)
...
--
-- TOC entry 5358 (class 1259 OID 16953)
...
--
-- TOC entry 5510 (class 1259 OID 19655)
...
--
-- TOC entry 5511 (class 1259 OID 19654)
...
--
-- TOC entry 5555 (class 1259 OID 20008)
...
--
-- TOC entry 5471 (class 1259 OID 19755)
...
--
-- TOC entry 5542 (class 1259 OID 19940)
...
--
-- TOC entry 5406 (class 1259 OID 17191)
...
--
-- TOC entry 5407 (class 1259 OID 17192)
...
--
-- TOC entry 5590 (class 1259 OID 20885)
...
--
-- TOC entry 5597 (class 1259 OID 20909)
...
--
-- TOC entry 5593 (class 1259 OID 20900)
...
--
-- TOC entry 5594 (class 1259 OID 20899)
...
--
-- TOC entry 5605 (class 1259 OID 20962)
...
--
-- TOC entry 5600 (class 1259 OID 20928)
...
--
-- TOC entry 5365 (class 1259 OID 16991)
...
--
-- TOC entry 5366 (class 1259 OID 16992)
...
--
-- TOC entry 5359 (class 1259 OID 16964)
...
--
-- TOC entry 5380 (class 1259 OID 17069)
...
--
-- TOC entry 5381 (class 1259 OID 17070)
...
--
-- TOC entry 5372 (class 1259 OID 17045)
...
--
-- TOC entry 5373 (class 1259 OID 17044)
...
--
-- TOC entry 5374 (class 1259 OID 20746)
...
--
-- TOC entry 5375 (class 1259 OID 17043)
...
--
-- TOC entry 5384 (class 1259 OID 17091)
...
--
-- TOC entry 5385 (class 1259 OID 20748)
...
--
-- TOC entry 5386 (class 1259 OID 17093)
...
--
-- TOC entry 5387 (class 1259 OID 17092)
...
--
-- TOC entry 5256 (class 1259 OID 16569)
...
--
-- TOC entry 5538 (class 1259 OID 19913)
...
--
-- TOC entry 5539 (class 1259 OID 19914)
...
--
-- TOC entry 5272 (class 1259 OID 16571)
...
--
-- TOC entry 5273 (class 1259 OID 16572)
...
--
-- TOC entry 5264 (class 1259 OID 19894)
...
--
-- TOC entry 5265 (class 1259 OID 19895)
...
--
-- TOC entry 5498 (class 1259 OID 19618)
...
--
-- TOC entry 5499 (class 1259 OID 19617)
...
--
-- TOC entry 5259 (class 1259 OID 16570)
...
--
-- TOC entry 5246 (class 1259 OID 16565)
...
--
-- TOC entry 5247 (class 1259 OID 16564)
...
--
-- TOC entry 5248 (class 1259 OID 19379)
...
--
-- TOC entry 5249 (class 1259 OID 20744)
...
--
-- TOC entry 5492 (class 1259 OID 19756)
...
--
-- TOC entry 5493 (class 1259 OID 19594)
...
--
-- TOC entry 5390 (class 1259 OID 17124)
...
--
-- TOC entry 5391 (class 1259 OID 17125)
...
--
-- TOC entry 5392 (class 1259 OID 20750)
...
--
-- TOC entry 5512 (class 1259 OID 19692)
...
--
-- TOC entry 5513 (class 1259 OID 19693)
...
--
-- TOC entry 5732 (class 1259 OID 21998)
...
--
-- TOC entry 5744 (class 1259 OID 22090)
...
--
-- TOC entry 5557 (class 1259 OID 20367)
...
--
-- TOC entry 5400 (class 1259 OID 17156)
...
--
-- TOC entry 5230 (class 1259 OID 16563)
...
--
-- TOC entry 5231 (class 1259 OID 16561)
...
--
-- TOC entry 5232 (class 1259 OID 20742)
...
--
-- TOC entry 5233 (class 1259 OID 16562)
...
--
-- TOC entry 5488 (class 1259 OID 19640)
...
--
-- TOC entry 5489 (class 1259 OID 19641)
...
--
-- TOC entry 5561 (class 1259 OID 20712)
...
--
-- TOC entry 5562 (class 1259 OID 20714)
...
--
-- TOC entry 5563 (class 1259 OID 20713)
...
--
-- TOC entry 5797 (class 1259 OID 22687)
...
--
-- TOC entry 5798 (class 1259 OID 22686)
...
--
-- TOC entry 5423 (class 1259 OID 19573)
...
--
-- TOC entry 5424 (class 1259 OID 19571)
...
--
-- TOC entry 5425 (class 1259 OID 19572)
...
--
-- TOC entry 5293 (class 1259 OID 16631)
...
--
-- TOC entry 5576 (class 1259 OID 20802)
...
--
-- TOC entry 5577 (class 1259 OID 20803)
...
--
-- TOC entry 5296 (class 1259 OID 16650)
...
--
-- TOC entry 5297 (class 1259 OID 16649)
...
--
-- TOC entry 5300 (class 1259 OID 16671)
...
--
-- TOC entry 5528 (class 1259 OID 19754)
...
--
-- TOC entry 5529 (class 1259 OID 19753)
...
--
-- TOC entry 5303 (class 1259 OID 16686)
...
--
-- TOC entry 5278 (class 1259 OID 16592)
...
--
-- TOC entry 5289 (class 1259 OID 16615)
...
--
-- TOC entry 5290 (class 1259 OID 16614)
...
--
-- TOC entry 5279 (class 1259 OID 20740)
...
--
-- TOC entry 5280 (class 1259 OID 16591)
...
--
-- TOC entry 5685 (class 1259 OID 21642)
...
--
-- TOC entry 5674 (class 1259 OID 21553)
...
--
-- TOC entry 5556 (class 1259 OID 20571)
...
--
-- TOC entry 5741 (class 1259 OID 22043)
...
--
-- TOC entry 5444 (class 1259 OID 21058)
...
--
-- TOC entry 5580 (class 1259 OID 20813)
...
--
-- TOC entry 5560 (class 1259 OID 20679)
...
--
-- TOC entry 5558 (class 1259 OID 20693)
...
--
-- TOC entry 5559 (class 1259 OID 20655)
...
--
-- TOC entry 5964 (class 2620 OID 19394)
...
--
-- TOC entry 5969 (class 2620 OID 19391)
...
--
-- TOC entry 5966 (class 2620 OID 19390)
...
--
-- TOC entry 5971 (class 2620 OID 19392)
...
--
-- TOC entry 5961 (class 2620 OID 19389)
...
--
-- TOC entry 5959 (class 2620 OID 19388)
...
--
-- TOC entry 5974 (class 2620 OID 19393)
...
--
-- TOC entry 5976 (class 2620 OID 19395)
...
--
-- TOC entry 5977 (class 2620 OID 19396)
...
--
-- TOC entry 5957 (class 2620 OID 19398)
...
--
-- TOC entry 5962 (class 2620 OID 19397)
...
--
-- TOC entry 5978 (class 2620 OID 21022)
...
--
-- TOC entry 5965 (class 2620 OID 20723)
...
--
-- TOC entry 5970 (class 2620 OID 20717)
...
--
-- TOC entry 5967 (class 2620 OID 20716)
...
--
-- TOC entry 5972 (class 2620 OID 20721)
...
--
-- TOC entry 5960 (class 2620 OID 20718)
...
--
-- TOC entry 5975 (class 2620 OID 20722)
...
--
-- TOC entry 5958 (class 2620 OID 20720)
...
--
-- TOC entry 5963 (class 2620 OID 20719)
...
--
-- TOC entry 5979 (class 2620 OID 22103)
...
--
-- TOC entry 5968 (class 2620 OID 22029)
...
--
-- TOC entry 5973 (class 2620 OID 22030)
...
--
-- TOC entry 5980 (class 2620 OID 22302)
...
--
-- TOC entry 5917 (class 2606 OID 20859)
...
--
-- TOC entry 5918 (class 2606 OID 20854)
...
--
-- TOC entry 5831 (class 2606 OID 16769)
...
--
-- TOC entry 5830 (class 2606 OID 16756)
...
--
-- TOC entry 5841 (class 2606 OID 16885)
...
--
-- TOC entry 5827 (class 2606 OID 16722)
...
--
-- TOC entry 5828 (class 2606 OID 16717)
...
--
-- TOC entry 5829 (class 2606 OID 16741)
...
--
-- TOC entry 5936 (class 2606 OID 21691)
...
--
-- TOC entry 5933 (class 2606 OID 21658)
...
--
-- TOC entry 5934 (class 2606 OID 21653)
...
--
-- TOC entry 5935 (class 2606 OID 21675)
...
--
-- TOC entry 5952 (class 2606 OID 22267)
...
--
-- TOC entry 5927 (class 2606 OID 21284)
...
--
-- TOC entry 5928 (class 2606 OID 21289)
...
--
-- TOC entry 5950 (class 2606 OID 22247)
...
--
-- TOC entry 5951 (class 2606 OID 22252)
...
--
-- TOC entry 5949 (class 2606 OID 22236)
...
--
-- TOC entry 5925 (class 2606 OID 21225)
...
--
-- TOC entry 5924 (class 2606 OID 21205)
...
--
-- TOC entry 5931 (class 2606 OID 21600)
...
--
-- TOC entry 5932 (class 2606 OID 21613)
...
--
-- TOC entry 5943 (class 2606 OID 21931)
...
--
-- TOC entry 5941 (class 2606 OID 21887)
...
--
-- TOC entry 5942 (class 2606 OID 21902)
...
--
-- TOC entry 5930 (class 2606 OID 21516)
...
--
-- TOC entry 5937 (class 2606 OID 21728)
...
--
-- TOC entry 5929 (class 2606 OID 21501)
...
--
-- TOC entry 5922 (class 2606 OID 21100)
...
--
-- TOC entry 5923 (class 2606 OID 21105)
...
--
-- TOC entry 5926 (class 2606 OID 21242)
...
--
-- TOC entry 5939 (class 2606 OID 21800)
...
--
-- TOC entry 5938 (class 2606 OID 21786)
...
--
-- TOC entry 5940 (class 2606 OID 21849)
...
--
-- TOC entry 5948 (class 2606 OID 22126)
...
--
-- TOC entry 5919 (class 2606 OID 21012)
...
--
-- TOC entry 5911 (class 2606 OID 19991)
...
--
-- TOC entry 5811 (class 2606 OID 19164)
...
--
-- TOC entry 5910 (class 2606 OID 19973)
...
--
-- TOC entry 5842 (class 2606 OID 16931)
...
--
-- TOC entry 5843 (class 2606 OID 19368)
...
--
-- TOC entry 5844 (class 2606 OID 19363)
...
--
-- TOC entry 5845 (class 2606 OID 19358)
...
--
-- TOC entry 5848 (class 2606 OID 19249)
...
--
-- TOC entry 5849 (class 2606 OID 18964)
...
--
-- TOC entry 5846 (class 2606 OID 19244)
...
--
-- TOC entry 5839 (class 2606 OID 16854)
...
--
-- TOC entry 5891 (class 2606 OID 18006)
...
--
-- TOC entry 5885 (class 2606 OID 19062)
...
--
-- TOC entry 5881 (class 2606 OID 17956)
...
--
-- TOC entry 5882 (class 2606 OID 19192)
...
--
-- TOC entry 5883 (class 2606 OID 18989)
...
--
-- TOC entry 5880 (class 2606 OID 19268)
...
--
-- TOC entry 5887 (class 2606 OID 19273)
...
--
-- TOC entry 5879 (class 2606 OID 19057)
...
--
-- TOC entry 5884 (class 2606 OID 18994)
...
--
-- TOC entry 5892 (class 2606 OID 18999)
...
--
-- TOC entry 5893 (class 2606 OID 19004)
...
--
-- TOC entry 5868 (class 2606 OID 19182)
...
--
-- TOC entry 5867 (class 2606 OID 19177)
...
--
-- TOC entry 5850 (class 2606 OID 19223)
...
--
-- TOC entry 5851 (class 2606 OID 19759)
...
--
-- TOC entry 5872 (class 2606 OID 19120)
...
--
-- TOC entry 5869 (class 2606 OID 19187)
...
--
-- TOC entry 5870 (class 2606 OID 19115)
...
--
-- TOC entry 5871 (class 2606 OID 18969)
...
--
-- TOC entry 5888 (class 2606 OID 19215)
...
--
-- TOC entry 5889 (class 2606 OID 19125)
...
--
-- TOC entry 5890 (class 2606 OID 19236)
...
--
-- TOC entry 5886 (class 2606 OID 19373)
...
--
-- TOC entry 5895 (class 2606 OID 19764)
...
--
-- TOC entry 5894 (class 2606 OID 19009)
...
--
-- TOC entry 5877 (class 2606 OID 19052)
...
--
-- TOC entry 5878 (class 2606 OID 18984)
...
--
-- TOC entry 5873 (class 2606 OID 18974)
...
--
-- TOC entry 5875 (class 2606 OID 17931)
...
--
-- TOC entry 5876 (class 2606 OID 18979)
...
--
-- TOC entry 5907 (class 2606 OID 19935)
...
--
-- TOC entry 5864 (class 2606 OID 17186)
...
--
-- TOC entry 5865 (class 2606 OID 19110)
...
--
-- TOC entry 5866 (class 2606 OID 19148)
...
--
-- TOC entry 5913 (class 2606 OID 20779)
...
--
-- TOC entry 5847 (class 2606 OID 16986)
...
--
-- TOC entry 5920 (class 2606 OID 21070)
...
--
-- TOC entry 5921 (class 2606 OID 21075)
...
--
-- TOC entry 5855 (class 2606 OID 19318)
...
--
-- TOC entry 5856 (class 2606 OID 19323)
...
--
-- TOC entry 5857 (class 2606 OID 19328)
...
--
-- TOC entry 5838 (class 2606 OID 16840)
...
--
-- TOC entry 5852 (class 2606 OID 19313)
...
--
-- TOC entry 5853 (class 2606 OID 19308)
...
--
-- TOC entry 5854 (class 2606 OID 19303)
...
--
-- TOC entry 5858 (class 2606 OID 19333)
...
--
-- TOC entry 5859 (class 2606 OID 19338)
...
--
-- TOC entry 5814 (class 2606 OID 19298)
...
--
-- TOC entry 5834 (class 2606 OID 16807)
...
--
-- TOC entry 5835 (class 2606 OID 19105)
...
--
-- TOC entry 5905 (class 2606 OID 19903)
...
--
-- TOC entry 5906 (class 2606 OID 19908)
...
--
-- TOC entry 5818 (class 2606 OID 19090)
...
--
-- TOC entry 5816 (class 2606 OID 20039)
...
--
-- TOC entry 5817 (class 2606 OID 20044)
...
--
-- TOC entry 5897 (class 2606 OID 19612)
...
--
-- TOC entry 5815 (class 2606 OID 19293)
...
--
-- TOC entry 5812 (class 2606 OID 19288)
...
--
-- TOC entry 5813 (class 2606 OID 19283)
...
--
-- TOC entry 5860 (class 2606 OID 19343)
...
--
-- TOC entry 5861 (class 2606 OID 19348)
...
--
-- TOC entry 5862 (class 2606 OID 19353)
...
--
-- TOC entry 5898 (class 2606 OID 19677)
...
--
-- TOC entry 5899 (class 2606 OID 19687)
...
--
-- TOC entry 5900 (class 2606 OID 19682)
...
--
-- TOC entry 5908 (class 2606 OID 19959)
...
--
-- TOC entry 5909 (class 2606 OID 19954)
...
--
-- TOC entry 5901 (class 2606 OID 19729)
...
--
-- TOC entry 5902 (class 2606 OID 19724)
...
--
-- TOC entry 5945 (class 2606 OID 22018)
...
--
-- TOC entry 5944 (class 2606 OID 21993)
...
--
-- TOC entry 5946 (class 2606 OID 22085)
...
--
-- TOC entry 5947 (class 2606 OID 22080)
...
--
-- TOC entry 5953 (class 2606 OID 22732)
...
--
-- TOC entry 5954 (class 2606 OID 22727)
...
--
-- TOC entry 5832 (class 2606 OID 16788)
...
--
-- TOC entry 5833 (class 2606 OID 19042)
...
--
-- TOC entry 5863 (class 2606 OID 19047)
...
--
-- TOC entry 5955 (class 2606 OID 22753)
-- Name: shop_staff shop_staff_shop_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 5956 (class 2606 OID 22758)
-- Name: shop_staff shop_staff_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.shop_staff
    ADD CONSTRAINT shop_staff_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id) ON DELETE CASCADE;


--
-- TOC entry 5896 (class 2606 OID 19544)
...
--
-- TOC entry 5840 (class 2606 OID 16870)
...
--
-- TOC entry 5874 (class 2606 OID 19566)
...
--
-- TOC entry 5821 (class 2606 OID 18939)
...
--
-- TOC entry 5914 (class 2606 OID 20797)
...
--
-- TOC entry 5822 (class 2606 OID 19095)
...
--
-- TOC entry 5823 (class 2606 OID 18944)
...
--
-- TOC entry 5836 (class 2606 OID 16826)
...
--
-- TOC entry 5837 (class 2606 OID 18959)
...
--
-- TOC entry 5915 (class 2606 OID 20829)
...
--
-- TOC entry 5916 (class 2606 OID 20824)
...
--
-- TOC entry 5824 (class 2606 OID 19100)
...
--
-- TOC entry 5825 (class 2606 OID 18949)
...
--
-- TOC entry 5903 (class 2606 OID 19748)
...
--
-- TOC entry 5904 (class 2606 OID 19743)
...
--
-- TOC entry 5912 (class 2606 OID 20764)
...
--
-- TOC entry 5826 (class 2606 OID 18954)
...
--
-- TOC entry 5819 (class 2606 OID 19037)
...
--
-- TOC entry 5820 (class 2606 OID 18934)
...
--
-- TOC entry 6196 (class 0 OID 17015)
-- Dependencies: 297
...
--
-- TOC entry 6197 (class 0 OID 17072)
-- Dependencies: 301
...
--
-- TOC entry 6249 (class 3256 OID 22596)
...
--
-- TOC entry 6239 (class 3256 OID 22597)
...
--
-- TOC entry 6247 (class 3256 OID 22598)
...
--
-- TOC entry 6248 (class 3256 OID 22599)
...
--
-- TOC entry 6220 (class 3256 OID 22600)
...
--
-- TOC entry 6218 (class 3256 OID 22601)
...
--
-- TOC entry 6224 (class 3256 OID 22602)
...
--
-- TOC entry 6245 (class 3256 OID 22603)
...
--
-- TOC entry 6217 (class 3256 OID 22604)
...
--
-- TOC entry 6233 (class 3256 OID 22605)
...
--
-- TOC entry 6232 (class 3256 OID 22606)
...
--
-- TOC entry 6238 (class 3256 OID 22607)
...
--
-- TOC entry 6240 (class 3256 OID 22608)
...
--
-- TOC entry 6237 (class 3256 OID 22609)
...
--
-- TOC entry 6214 (class 3256 OID 22610)
...
--
-- TOC entry 6228 (class 3256 OID 22611)
...
--
-- TOC entry 6216 (class 3256 OID 22612)
...
--
-- TOC entry 6231 (class 3256 OID 22613)
...
--
-- TOC entry 6225 (class 3256 OID 22614)
...
--
-- TOC entry 6227 (class 3256 OID 22615)
...
--
-- TOC entry 6246 (class 3256 OID 22616)
...
--
-- TOC entry 6215 (class 3256 OID 22617)
...
--
-- TOC entry 6219 (class 3256 OID 22618)
...
--
-- TOC entry 6250 (class 3256 OID 22619)
...
--
-- TOC entry 6229 (class 3256 OID 22620)
...
--
-- TOC entry 6230 (class 3256 OID 22621)
...
--
-- TOC entry 6234 (class 3256 OID 22622)
...
--
-- TOC entry 6226 (class 3256 OID 22623)
...
--
-- TOC entry 6236 (class 3256 OID 22624)
...
--
-- TOC entry 6235 (class 3256 OID 22625)
...
--
-- TOC entry 6213 (class 3256 OID 22626)
...
--
-- TOC entry 6212 (class 3256 OID 22627)
...
--
-- TOC entry 6222 (class 3256 OID 22628)
...
--
-- TOC entry 6223 (class 3256 OID 22629)
...
--
-- TOC entry 6201 (class 3256 OID 22630)
...
--
-- TOC entry 6207 (class 3256 OID 22631)
...
--
-- TOC entry 6211 (class 3256 OID 22632)
...
--
-- TOC entry 6206 (class 3256 OID 22633)
...
--
-- TOC entry 6210 (class 3256 OID 22634)
...
--
-- TOC entry 6208 (class 3256 OID 22635)
...
--
-- TOC entry 6209 (class 3256 OID 22636)
...
--
-- TOC entry 6202 (class 3256 OID 21390)
...
--
-- TOC entry 6203 (class 3256 OID 22637)
...
--
-- TOC entry 6199 (class 3256 OID 22638)
...
--
-- TOC entry 6204 (class 3256 OID 22639)
...
--
-- TOC entry 6242 (class 3256 OID 22112)
...
--
-- TOC entry 6241 (class 3256 OID 22111)
...
--
-- TOC entry 6198 (class 3256 OID 22640)
...
--
-- TOC entry 6243 (class 3256 OID 22641)
...
--
-- TOC entry 6244 (class 3256 OID 22642)
...
--
-- TOC entry 6251 (class 3256 OID 22643)
...
--
-- TOC entry 6221 (class 3256 OID 22644)
...
--
-- TOC entry 6205 (class 3256 OID 22645)
...
--
-- TOC entry 6200 (class 3256 OID 22646)
...
--
-- TOC entry 6195 (class 0 OID 16575)
-- Dependencies: 245
...
-- Completed on 2025-10-27 18:17:36
